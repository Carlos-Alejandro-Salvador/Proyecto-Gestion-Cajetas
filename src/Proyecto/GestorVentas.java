...
public class GestorVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, 250, -1));
        ...
        jButton5.setText("Consultar Ventas Generales");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                VentasForm form = new VentasForm(2);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Ventas");
            }
         } 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        super.dispose();
        VentasForm form = new VentasForm(1);
        form.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                GeneralVentas form = new GeneralVentas();
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Ventas");
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                VentasForm form = new VentasForm(3);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Ventas");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                VentasForm form = new VentasForm(4);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Ventas");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestorVentas().setVisible(true);
            }
        });
    }
