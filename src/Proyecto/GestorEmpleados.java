...
public class GestorEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("Consulta General Empleados");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(249, 220, 280, -1));
        ...
        jButton2.setText("Consulta Individual Empleados");
        ...
        jButton4.setText("Eliminar Empleados");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        super.dispose();
        EmpleadosForm form = new EmpleadosForm(1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                EmpleadosForm form = new EmpleadosForm(2);
                form.setVisible(true); 
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Empleados");
            }
         } 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                EmpleadosForm form = new EmpleadosForm(3);
                form.setVisible(true); 
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Empleados");
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                GeneralEmpleados form = new GeneralEmpleados();
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Empleados");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                EmpleadosForm form = new EmpleadosForm(4);
                form.setVisible(true); 
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Empleados");
            }
