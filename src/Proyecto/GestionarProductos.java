...
public class GestionarProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(227, 290, 290, -1));
        ...
        jPanel1.add(btnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 430, 110, -1));

        jButton6.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jButton6.setText("Consulta General Productos");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 290, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        super.dispose();
        ProductosForm form = new ProductosForm(1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                ProductosForm form = new ProductosForm(2);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Productos");
            }
         } 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                ProductosForm form = new ProductosForm(3);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Productos");
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                GeneralProductos gen = new GeneralProductos();
                gen.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Productos");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if(existe){
                super.dispose();
                ProductosForm form = new ProductosForm(4);
                form.setVisible(true);
            }   else    {
                JOptionPane.showMessageDialog(null, "No se han ingresado Productos");
            }
